...
from tmp.dictionary import Dictionary
from tmp.tokenized import tokenize as twitter_tokenize
from tmp.twitter import Seme_tweet, Multi_target_tweet
...
class Corpus(object):
    ...
    def idxed_data(self):
        for item in self.tweets:
            item.tokenize_by_dict(self.dictionary)
