...
from model import Text_Condition_Encoder, Fast_Text, Text_CNN, Text_LSTM
...
def train(model, config, loss_fun, optim, target_idx):
    ...
    all_loss = 0.0
    sample_len = 0
    for id_, (idx_tweets, idx_target, stances, sentiments, target_idx) in enumerate(corpus.iter_epoch(target_idx, "Train", batch_size=18)):
